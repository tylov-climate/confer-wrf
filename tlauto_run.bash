...
if [ -z "$1" ]; then
  echo "Usage: $0 <year> <imonth> <iday> [download [force]]"
  echo ""
  echo " e.g.: $0 1991 02 10"
  exit
fi
year=$1
imon=$2
...
pushd WPS
  ...
  sed -i -e "s/YYYY/$year/g" namelist.wps
  #sed -i -e "s/YYYY/$year/g" run_geogrid.sh
  #sed -i -e "s/YYYY/$year/g" run_ungrib.sh
  sed -i -e "s/YYYY/$year/g" run_wps.sh
  sed -i -e "s/YYYY/$year/g" run_metgrid.sh
...
pushd WRFRUN
  ...
  sed -i -e "s/YYYY/$year/g" namelist.input
  sed -i -e "s/YYYY/$year/g" copy_output.sh
  sed -i -e "s/YYYY/$year/g" run_real.sh
  sed -i -e "s/YYYY/$year/g" run_wrf.sh
